<?php
    $keyID = htmlspecialchars($_GET['movie_id']);
?>
...
?>
    <div class="container">
        <div class="row centered-form">
			...
			<form method="POST" action="editMovieHandler.php?movie_id=<?php echo $keyID ?>">
                            <div class="form-group">
                            <input type="text" name="movieName" id="movieName" class="form-control input-sm" placeholder="Movie Name">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="hidden" name="movie_id" value="<?php echo $keyID?>">
