<?php
    $keyID = htmlspecialchars($_GET['comic_id']);
?>
    ...
    <div class="container">
        <div class="row centered-form">
        	...
        	<div class="panel panel-default">
		        ...
		        <h3 class="panel-title">Edit Comic</h3>
		    </div>
		    <div class="panel-body">
			<form method="POST" action="editComicHandler.php?comic_id=<?php echo $keyID ?>">
                            <div class="form-group">
                            <input type="text" name="comicName" id="comicName" class="form-control input-sm" placeholder="Comic Name">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="hidden" name="comic_id" value="<?php echo $keyID?>">
